...
trait MDT_UploadImag
{
    ...
    public function MDT_saveImage($file , $name , $path ='assets/admin/images/products/min/'){
...
//                $constraint->upsize();
    ...
    public function MDT_saveMultiImage($files, $name , $fk_id=['nameKey' , 'id'] , $path='assets/admin/images/products/gallery/' ){
    ...
    public function MDT_deleteImage($img , $path ='assets/admin/images/products/min'){
    ...
    public function MDT_deleteMultiImage($images , $path ='assets/admin/images/products/gallery'){
