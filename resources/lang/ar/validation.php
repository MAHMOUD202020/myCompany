...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "status"            => 'الحالة',
        "note"              => 'ملاحظة',
        "available_date"    => 'متاح للشحن من تاريخ',
        "serial"            => 'السريال',
        "phone_company"     => 'هاتف الشركة',
        "name_company"      => 'اسم الشركة',
        "address_company"   => 'عنوان الشركة',
        "phone2_company"    => 'الهاتف الثاني للشركة',
        "phone_customer"    => 'رقم العميل',
        "name_customer"     => 'اسم العميل',
        "address_customer"  => 'عنوان العميل',
        "phone2_customer"   => 'الهاتف الثاني للعميل',
        'oldPassword'       => 'كلمة المرور القديمة',
        'newPassword'       => 'كلمة المرور الجديدة',
        'name_ar'           => 'الاسم بالعربيه',
        'name_en'           => 'الاسم بالآنجليزيه',
        'description_ar'    => 'الوصف بالعربيه',
        'description_en'    => 'الوصف بالآنجليزيه',
        'quantity'          => 'الكمية',
        'regular_price'     => 'سعر المنتج',
        'sale_price'        => 'سعر الخصم',
        'start_sale'        => 'تاريخ بداية الخصم',
        'end_sale'          => 'تاريخ نهاية الخصم',
