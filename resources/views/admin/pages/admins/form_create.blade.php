<form method="post" action="{{ route('admin.admins.store')}}" id="form_add_option">
    ...
    <div class="form-row mb-4">
        ...
        <div class="form-group col-md-6">
            ...
            <input name="email" type="email" maxlength="100" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="@lang('form.placeholder.Admin email')" value="{{old('email')}}" required>
