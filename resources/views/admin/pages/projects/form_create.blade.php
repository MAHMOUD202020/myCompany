<form method="post" action="{{ route('admin.projects.store')}}" enctype="multipart/form-data">
    ...
    <div class="form-row mb-4">
        ...
        <div class="form-group col-md-6">
            <label for="category_ar">@lang('form.label.project category_ar')</label>
            <input name="category_ar" type="text" maxlength="100" class="form-control @error('category_ar') is-invalid @enderror" id="category_ar" value="{{old('category_ar')}}" required>
            @error('category_ar')<span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>@enderror
        </div>

        <div class="form-group col-md-6">
            <label for="category_en">@lang('form.label.project category_en')</label>
            <input name="category_en" type="text" maxlength="100" class="form-control @error('category_en') is-invalid @enderror" id="category_en" value="{{old('category_en')}}" required>
