...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>{{$page["name_".app()->getLocale()]}}</span></li>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                        ...
                        <div class="widget-content widget-content-area">
                            @include('admin.pages.pages.form_show')
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script>
        ...
        tinymce.init({
            ...
            images_upload_url: '{{route('admin.pages.uploadImage')}}',
