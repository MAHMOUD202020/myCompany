    ...
    <div class="form-row mb-4">
        ...
        <div class="form-group col-md-6">
            <label for="is_home">Add This item In Home Page
                <input name="is_home" style="width: 20px; height: 20px;     position: relative; top: 7px;" type="checkbox"  class=" checkbox @error('is_home') is-invalid @enderror" id="is_home"  @checked(old('is_home'))  value="1" >
            </label>
