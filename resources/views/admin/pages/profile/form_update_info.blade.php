        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input readonly name="email" type="email" id="input-email" class="form-control form-control-alternative @error('email') is-invalid @enderror" value="{{$auth->email}}" required>
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
