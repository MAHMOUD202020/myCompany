...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>اضافة تصنيف</span></li>
@endsection
...
@section('css')
    <link href="{{asset('assets/admin/plugins/drag-and-drop/dragula/dragula.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('assets/admin/plugins/drag-and-drop/dragula/example.css')}}" rel="stylesheet" type="text/css" />
