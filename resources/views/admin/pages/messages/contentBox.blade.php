                    ...
                    <div class="d-flex user-info">
                        <div class="f-body">
                            <div class="meta-title-tag">
                                <h4 class="mail-usr-name" data-mailtitle="Hosting Payment Reminder">{{$message->name}}</h4>
                            </div>
                            <div class="meta-mail-time">
                                <p class="user-email" data-mailto="kingAndy@mail.com">{{$message->email}}</p>-
                                <p class="user-email" data-mailto="kingAndy@mail.com">{{$message->phone}}</p>-
                                <p class="meta-time align-self-center">{{$message->created_at}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <p class="mail-content" data-mailTitle="{{$message->title}}">{{$message->message}} </p>
            </div>
        </div>
    @endforeach
