                            ...
                            <div class="mail-item-inner">
                                ...
                                <div class="d-flex">
                                    <div class="n-chk text-center">
                                        @can('role' , 'message.destroy')
                                        <a class="delete-message" href="{{ route('admin.messages.destroy' , $message->id)}}">
                                    ...
                                    <div class="f-body">
                                        <div class="meta-mail-time">
                                            <p class="user-email" data-mailTo="kingAndy@mail.com">{{$message->name}}</p>
                                        </div>
                                        <div class="meta-title-tag">
                                            <p class="mail-content-excerpt"><span class="mail-title ml-3">{{$message->subject}} -</span> {{substr($message->message , 0 , 50)}}</p>
