...
{{--            </li>--}}
            ...
            <li class="nav-item dropdown language-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{asset('assets/admin/img/languages.png')}}" class="flag-width" alt="flag">
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a  class="dropdown-item d-flex" href="{{ route('admin.lang.change' , 'ar')}}"><img src="{{asset('assets/admin/img/Flag_of_Indonesia.svg')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;عربي</span></a>
                    <a class="dropdown-item d-flex" href="{{ route('admin.lang.change' , 'en')}}"><img src="{{asset('assets/admin/img/ca.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;English</span></a>
                </div>
            </li>
